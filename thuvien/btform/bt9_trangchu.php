  ...
  <div class="main-content">
    <div class="wrapper">
      ...
      <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link active" href="bt9_index.php">Index</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="bt9_trangchu.php">Trang chủ</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="bt9_gioithieu.php">Giới thiệu</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="bt9_tintuc.php">Tin tức</a>
        </li>
        <li class="nav-item">
      ...
      <h3>Chào mừng các bạn đến với website của chúng tôi!</h3>
    </div>
    </div>
  </div>
