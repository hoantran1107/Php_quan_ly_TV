    ...
    <div class="wrapper">
      ...
      <div class="container-sm">
        <ul class="nav nav-tabs">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="bt9_lienhe.php">Liên hệ</a>
          </li>
          <li class="nav-item">
        ...
        <h3>Mọi chi tiết xin liên hệ tới chúng tôi thông qua form liên hệ của website</h3>
